...
/**
 * print_osabi - function that prints ELF header osabi
...
/**
 * print_abi - function that prints ELF header abi
...
/**
 * print_entry - function that prints ELF header entry address
